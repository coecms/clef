 ...
 * :code:`clef --local cmip5` finds local files accessing directly the CLEF database so it will also return older versions or datasets that might be temporarily offline.
